const C='lv66-lagerbestand-techniker-m365-1';
const A=['./','index.html','app_rules.js','auth_core.js','transaction_core.js','help_core.js','sync_core.js','v66_core.js','local_backend.js','manifest.webmanifest','materialanforderung_vorlage.xlsx','materialanforderung_vorlage_lang.xlsx','https://cdnjs.cloudflare.com/ajax/libs/sql.js/1.10.3/sql-wasm.js','https://cdnjs.cloudflare.com/ajax/libs/sql.js/1.10.3/sql-wasm.wasm','https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js','https://cdnjs.cloudflare.com/ajax/libs/exceljs/4.4.0/exceljs.min.js','https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js'];
...
self.addEventListener('fetch',event=>{
 ...
 const networkFirst=event.request.mode==='navigate'||/\/(index\.html|local_backend\.js|sync_core\.js|app_rules\.js|help_core\.js|manifest\.webmanifest)$/.test(url.pathname);
 if(networkFirst){
